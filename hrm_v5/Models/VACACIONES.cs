...
namespace hrm_v5.Models
{
    ...
    public partial class VACACIONES
    {
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Por favor ingrese la cantidad de dias"), DisplayName("Dias"), StringLength(2, ErrorMessage = "¡Demasiados dias!"), RegularExpression("([1-9][0-9]*)", ErrorMessage = "Formato Inválido.")]
