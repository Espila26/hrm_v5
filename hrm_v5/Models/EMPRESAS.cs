...
namespace hrm_v5.Models
{
    ...
    public partial class EMPRESAS
    {
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Por favor ingrese una razón social"), DisplayName("Razón Social"), StringLength(25, ErrorMessage = "Longitud de la razón social es muy extensa. Por favor no exceda los 25 caracteres."), RegularExpression("([A-Za-z])+( [A-Za-z]+)*", ErrorMessage = "Formato Inválido.")]
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Por favor ingrese una fecha de fundación"), DisplayName("Fecha de Fundación")]
